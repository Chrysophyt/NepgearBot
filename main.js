...
//bot.setWebHook('https://nepgearbot.herokuapp.com:'+port+'/bot'+token, __dirname+'/crt.pem');
...
bot.setWebHook('https://nepgearbot.herokuapp.com:80/'+token,__dirname+'/crt.pem');
